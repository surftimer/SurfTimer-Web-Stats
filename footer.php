    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-12 col-lg-6 text-center">
          ...
          <br class="my-0">
          <small class=""><a class="text-<?php if($darkMode) echo "light"; else echo "dark"; ?>" href="https://github.com/KristianP26/Surftimer-Web-Stats" title="Kristián Partl Github" target="_blank">Surftimer-Web-Stats</a> v1.13</small>
        </div>
      </div>
    </div>
  </footer>
