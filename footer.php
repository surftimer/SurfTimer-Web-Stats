                ...
                <div class="row">
                    <div class="text-center text-body col-lg-6 offset-lg-3">
                        <p>
                            ...
                            <br>
                            <small><a class="link-dark text-decoration-none" href="https://github.com/KristianP26/Surftimer-Web-Stats" title="Kristián Partl Github" target="_blank">Surftimer-Web-Stats</a> v.2.03</small>
                        </p>
                    </div>
                </div>
            </div>
