...
<footer id="sticky-footer" class="py-4 bg-light mt-5 shadow">
    <div class="container">
      <div class="text-right">
      </div>
      <div class="row">
        <div class="col-12 col-lg-6 text-center">
          Copyright &copy; 2020 - Surf Stats
          <br class="my-0">
        ...
        <div class="col-12 col-lg-6 text-center">
          ...
          <br class="my-0">
          <small class=""><a class="text-dark" href="https://github.com/KristianP26" title="Kristián Partl Github" target="_blank">Surftimer-Web-Stats</a> v1.01</small>
        </div>
      </div>
    </div>
  </footer>
