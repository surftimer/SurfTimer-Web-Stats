<?php
    ...
    $settings_player_profile_icon = $_ENV["PLAYER_PROFILE_ICON"] ?? $settings_player_profile_icon;
    $settings_map_link_icon = $_ENV["MAP_LINK_ICON"] ?? $settings_map_link_icon;
    ...
    $settings_player_flags           = $_ENV["PLAYER_FLAGS"] ?? $settings_player_flags;