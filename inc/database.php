...
$exists_mtcheck = (bool)mysqli_num_rows($result_mtcheck);
if(!$exists_mtcheck) $db_conn_surftimer->query($sql_mtcheck_add);
...
$exists_ptcheck = (bool)mysqli_num_rows($result_ptcheck);
if(!$exists_ptcheck) $db_conn_surftimer->query($sql_ptcheck_add);
...
$exists_ptcheck = (bool)mysqli_num_rows($result_ptcheck);
if(!$exists_ptcheck) $db_conn_surftimer->query($sql_bonuscheck_add);
...
$exists_ptcheck = (bool)mysqli_num_rows($result_ptcheck);
if(!$exists_ptcheck) $db_conn_surftimer->query($sql_wrcpcheck_add);
