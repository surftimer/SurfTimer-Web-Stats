...
//[ SORTING OPTIONS ]
  ...
  $lgsl_config['sort']['players'] = "time"; // OPTIONS: name  score time
...
//[ STAND-ALONE VERSION: LGSL ADMIN LOGON ]
  ...
  $lgsl_config['admin']['pass'] = "SupertajnehesloRoka12334dkDMOKLmkfdolsm";

//------------------------------------------------------------------------------------------------------------+
//[ DATABASE SETTINGS: FOR STAND-ALONE OR TO OVERRIDE CMS DEFAULTS ]

  $lgsl_config['db']['server'] = "pma.kiepownica.com";
  $lgsl_config['db']['user']   = "kristian";
  $lgsl_config['db']['pass']   = "jQhI0-7]PNj_ACVY";
  $lgsl_config['db']['db']     = "surfcommunity_web";
  $lgsl_config['db']['table']  = "web_lgsl";
...
//[ ADVANCED SETTINGS ]
  ...
  $lgsl_config['cache_time']    = 99;        // seconds=time before a server needs updating
  $lgsl_config['live_time']     = 20;         // seconds=time allowed for updating servers per page load
