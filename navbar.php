                    ...
                    <?php if($settings_language_enable): ?>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item <?php echo LanguageActive('Hindi'); ?>" href="<?php echo LanguageURL('Hindi');?>"><img src="./images/flags/in.svg" width="20" class="border align-middle" alt="IN Flag"> Hindi</a></li>
                                <li><a class="dropdown-item <?php echo LanguageActive('Hungarian'); ?>" href="<?php echo LanguageURL('Hungarian');?>"><img src="./images/flags/hu.svg" width="20" class="border align-middle" alt="HU Flag"> Hungarian</a></li>
                                ...
                                <li><a class="dropdown-item <?php echo LanguageActive('Bulgarian'); ?>" href="<?php echo LanguageURL('Bulgarian');?>"><img src="./images/flags/bg.svg" width="20" class="border align-middle" alt="BG Flag"> Bulgarian</a></li>
                            </ul>
                        </div>
                    <?php endif;?>
                    <li class="nav-item">
