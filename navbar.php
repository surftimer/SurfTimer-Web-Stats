                    ...
                    <?php if($settings_language_enable): ?>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item <?php echo LanguageActive('Korean'); ?>" href="<?php echo LanguageURL('Hindi');?>"><img src="./images/flags/in.svg" width="20" class="border align-middle" alt="IN Flag"> Hindi</a></li>
