                                    ...
                                    <table class="table table-hover shadow-sm card-body table-sm py-0 my-0">
                                        ...
                                        <tbody>
                                            <?php foreach($r10rs as $r10r): ?>
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="px-3"><?php echo CountryFlag($r10r['country'], $r10r['countryCode'], $r10r['continentCode']); ?> <?php echo $r10r['normal_name']; ?> <a href="dashboard-player.php?id=<?php echo $r10r['steamid64']; ?>" target="" title="<?php echo $r10r['name']; ?> - Surf Profile" class="text-muted"><i class="fas fa-user-circle"></i></a> <a href="https://steamcommunity.com/profiles/<?php echo $r10r['steamid64']; ?>" target="_blank" title="<?php echo $r10r['normal_name']; ?> - Steam Profile" class="text-muted"><i class="fab fa-steam"></i></a></td>
                                        ...
                                        <tbody>
                                            <?php $t10p_row_number = '0'; foreach($t10ps as $t10p): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?php echo CountryFlag($t10p['country'], $t10p['countryCode'], $t10p['continentCode']); ?> <?php echo $t10p['name']; ?>  <a href="dashboard-player.php?id=<?php echo $t10p['steamid64']; ?>" target="" title="<?php echo $t10p['name']; ?> - Surf Profile" class="text-muted"><i class="fas fa-user-circle"></i></a> <a href="https://steamcommunity.com/profiles/<?php echo $t10p['steamid64']; ?>" target="_blank" title="<?php echo $t10p['name']; ?> - Steam Profile" class="text-muted"><i class="fab fa-steam"></i></a></td>
                                        ...
                                        <tbody>
                                            <?php $t10wrh_row_number = '0'; foreach($t10wrhs as $t10wrh): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?php echo CountryFlag($t10wrh['country'], $t10wrh['countryCode'], $t10wrh['continentCode']); ?> <?php echo $t10wrh['name']; ?>  <a href="dashboard-player.php?id=<?php echo $t10wrh['steamid64']; ?>" target="" title="<?php echo $t10wrh['name']; ?> - Surf Profile" class="text-muted"><i class="fas fa-user-circle"></i></a> <a href="https://steamcommunity.com/profiles/<?php echo $t10wrh['steamid64']; ?>" target="_blank" title="<?php echo $t10wrh['name']; ?> - Steam Profile" class="text-muted"><i class="fab fa-steam"></i></a></td>
                                        ...
                                        <tbody>
                                            <?php $t10bwrh_row_number = '0'; foreach($t10bwrhs as $t10bwrh): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?php echo CountryFlag($t10bwrh['country'], $t10bwrh['countryCode'], $t10bwrh['continentCode']); ?> <?php echo $t10bwrh['name']; ?>  <a href="dashboard-player.php?id=<?php echo $t10bwrh['steamid64']; ?>" target="" title="<?php echo $t10bwrh['name']; ?> - Surf Profile" class="text-muted"><i class="fas fa-user-circle"></i></a> <a href="https://steamcommunity.com/profiles/<?php echo $t10bwrh['steamid64']; ?>" target="_blank" title="<?php echo $t10bwrh['name']; ?> - Steam Profile" class="text-muted"><i class="fab fa-steam"></i></a></td>
                                        ...
                                        <tbody>
                                            <?php $t10swrh_row_number = '0'; foreach($t10swrhs as $t10swrh): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?php echo CountryFlag($t10swrh['country'], $t10swrh['countryCode'], $t10swrh['continentCode']); ?> <?php echo $t10swrh['name']; ?>  <a href="dashboard-player.php?id=<?php echo $t10swrh['steamid64']; ?>" target="" title="<?php echo $t10swrh['name']; ?> - Surf Profile" class="text-muted"><i class="fas fa-user-circle"></i></a> <a href="https://steamcommunity.com/profiles/<?php echo $t10swrh['steamid64']; ?>" target="_blank" title="<?php echo $t10swrh['name']; ?> - Steam Profile" class="text-muted"><i class="fab fa-steam"></i></a></td>
