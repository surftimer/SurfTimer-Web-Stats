        ...
        <div class="col-lg-11 mx-auto pb-1">
            ...
            <section class="my-4 pb-1">
                <div class="" id="player-profile-load">
                    <h5><a href="dashboard-players.php" class="text-muted text-decoration-none">Surf Stat's Player Profile</a> / <?php echo $player_id; ?>  <a href="https://steamcommunity.com/profiles/<?php echo $player_id; ?>" target="_blank" title="<?php echo $player_id; ?> - Steam Profile" class="text-muted"><i class="fab fa-steam"></i></a></h5>
                    <hr class="mt-0 mb-3">
